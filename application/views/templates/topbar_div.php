        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    $result = mysqli_query($con, "SELECT * FROM input_spl");
                    $resultbaca = mysqli_query($con, "SELECT * FROM input_spl WHERE status_id=2");
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                ?>
                                    ...
                                    <a class="dropdown-item d-flex align-items-center <?= $baca ?>" href="<?=base_url("menu/data_div");?>?data=<?= $row['id_input'] ?>">
                                        <div class="mr-3">
